...
export const builtinExpressions: Expression[] = [
  ...
  expr('Focused', { width: 70, height: 58, pupilWidth: 50, pupilHeight: 50, upperEyelid: 10 }),
  expr('Angry', { height: 58, upperEyelid: 34, rotation: 10, pupilWidth: 46, pupilHeight: 46 }),
  expr('Surprised', { width: 96, height: 96, pupilWidth: 34, pupilHeight: 34, highlightSize: 30 }),
  expr('Confused', { rotation: 14, pupilX: -10, upperEyelid: 8, highlightX: 10 }),
  expr('Sleepy', { upperEyelid: 70, lowerEyelid: 12, height: 46 }),
  expr('Offline', { upperEyelid: 100, lowerEyelid: 20, height: 30, pupilWidth: 0, pupilHeight: 0 }),
  ...
  expr('Notification', { width: 86, height: 90, pupilWidth: 48, pupilHeight: 48, highlightSize: 26 }),
