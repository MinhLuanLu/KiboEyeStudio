...
type DisplayTab = 'screen' | 'appearance'

const DISPLAY_TABS: { value: DisplayTab; label: string }[] = [
...
export function DisplayPanel() {
  ...
  const [tab, setTab] = useState<DisplayTab>('screen')
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <PanelTabs tabs={DISPLAY_TABS} active={tab} onChange={setTab} />
